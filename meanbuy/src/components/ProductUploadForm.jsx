     ...
     return (
          ...
          >
               ...
               <Text textAlign={"left"} color={"#73879C"}>
                    ...
                    HappyCart.com) you wish to list on HappyCart.com at least 2
                    business days before the preferred listing date.
               </Text>

               <FormLabel>
                    Step 1: Please select whethre you intend to ship the
                    product, have the product available for in store pickup, or
                    both.
               </FormLabel>
               ...
               >
                    ...
                    />
                    <FormLabel mt={20}>
                         Step 3: Please enter product options (if any). *Please
                         upload URL images only. Images uploaded with an option
                         will be associated with that particular option.
                    </FormLabel>
                    <Box mt={5}>
                    ...
                    <Box mt={5}>
                         <table style={{ width: "100%", fontSize: "13px" }}>
                              <tr>
                                   <th style={{ width: "90px" }}>
                                        Min Price as Listed on MeanBuy (INR)
                                   </th>
                                   <th>
                                        {" "}
                                   ...
                                   <th>Buy Now Price for Shipments (INR)</th>
                                   <th>
                                        Lead Time for Shipments (Days -e.g.,3)
                                   </th>
